...
paths=os.listdir('./airfoil_database')
# print(paths)
for f in paths[:1]:
    a='./airfoil_database/'+f
    print(a)
    # skip the title of each data
    b=np.loadtxt(a, skiprows=1)
    # add two points in the data make the spline good
    b1=np.insert(b, [1,-1], [(1-1*0.001),b[0,1]], axis=0)
    print(b1)
